...
public class Linpack {
    ...
    static final double abs(final double d) {
        return (d >= 0) ? d : -d;
    }

    static double second_orig = -1;
    ...
    public static final void run_benchmark() {
     ...
     */
    static final int dgefa(final double a[][], final int n, int ipvt[]) {
        double[] col_k, col_j;
        double t;
        int j, k, kp1, l, nm1;
        int info;
     ...
     * blas daxpy,ddot
     */
    static final void dgesl(final double a[][], final int n, final int ipvt[], double b[], final int job) {
        double t;
        int k, kb, l, nm1, kp1;
     ...
     * mcj: declared some parameters as final
     */
    static final void dscal(final int n, final double da, double dx[], final int dx_off, final int incx) {
        int i, nincx;
     ...
     * linpack, 3/11/78.
     */
    static final int idamax(final int n, final double dx[], final int dx_off, final int incx) {
        double dmax, dtemp;
        int i, ix, itemp = 0;
     ...
     */
    static final double epslon(final double x) {
     ...
     */
    static final void dmxpy(final int n1, double y[], final int n2, final double x[], final double m[][]) {
        int j, i;
